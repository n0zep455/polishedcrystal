ShamoutiIsland_MapScriptHeader:
	...
	pokemon_event 25, 14, MARILL, SPRITEMOVEDATA_POKEMON, -1, PAL_MON_BLUE, ShamoutiIslandPikabluText, EVENT_SHAMOUTI_ISLAND_WILHOMENA
	object_event 20,  2, SPRITE_FAT_GUY, SPRITEMOVEDATA_SPINCLOCKWISE, 0, 0, (DAY), PAL_NPC_BROWN, OBJECTTYPE_COMMAND, jumptextfaceplayer, ShamoutiIslandFisherText, -1
	object_event 23,  2, SPRITE_FAT_GUY, SPRITEMOVEDATA_SPINCOUNTERCLOCKWISE, 0, 0, (DAY), PAL_NPC_BROWN, OBJECTTYPE_COMMAND, jumptextfaceplayer, ShamoutiIslandFisherText, -1
