GoldenrodMuseum2F_MapScriptHeader:
	...
	def_object_events
	object_event  4,  2, SPRITE_SIGHTSEER_M, SPRITEMOVEDATA_STANDING_UP, 0, 0, (EVE) | (NITE), 0, OBJECTTYPE_SCRIPT, 0, GoldenrodMuseum2FSightseerMScript, -1
	pokemon_event 5,  2, SMEARGLE, SPRITEMOVEDATA_POKEMON, (EVE) | (NITE), PAL_MON_BROWN, GoldenrodMuseum2FSmeargleText, -1
