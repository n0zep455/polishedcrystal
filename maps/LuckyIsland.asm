LuckyIsland_MapScriptHeader:
	...
	fruittree_event 31, 16, FRUITTREE_LUCKY_ISLAND, JABOCA_BERRY, PAL_NPC_ENV_YELLOW, ToD_MORN, EVENT_LUCKY_ISLAND_CIVILIANS
	fruittree_event 31, 16, FRUITTREE_LUCKY_ISLAND, ROWAP_BERRY, PAL_NPC_TEAL, ToD_DAY, EVENT_LUCKY_ISLAND_CIVILIANS
	fruittree_event 31, 16, FRUITTREE_LUCKY_ISLAND, KEE_BERRY, PAL_NPC_PINK, ToD_EVE, EVENT_LUCKY_ISLAND_CIVILIANS
	fruittree_event 31, 16, FRUITTREE_LUCKY_ISLAND, MARANGABERRY, PAL_NPC_BROWN, ToD_NITE, EVENT_LUCKY_ISLAND_CIVILIANS
